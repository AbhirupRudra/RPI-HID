...
G=/sys/kernel/config/usb_gadget/rpi_composite
STORAGE_IMG="/opt/usb-storage/storage.img"
...
echo "RPI02W1234" > strings/0x409/serialnumber
echo "Raspberry Pi" > strings/0x409/manufacturer
echo "RPI HID + Storage" > strings/0x409/product
